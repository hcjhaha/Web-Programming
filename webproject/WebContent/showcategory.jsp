		...
		<div id="center">
			<%
		 	try {
				...
				stmt = conn.prepareStatement("SELECT COUNT(*) FROM photo WHERE category = ?");
				...
				stmt = conn.prepareStatement("SELECT * FROM photo WHERE category = ? ORDER BY id DESC LIMIT " + startPos + ", " + numInPage);
				stmt.setString(1, category);
				rs = stmt.executeQuery();
			...
			<table class="table table-bordered table-stripped">
				<tr>
					...
					<div id="photolist">
						<div class="img">
							<a href="photoshow.jsp?id=<%=rs.getInt("id")%>"> <img
								src="/wp/uploadpicture/<%=rs.getString("photourl")%>" alt="">
							</a>
						</div>
					</div>
					<%
