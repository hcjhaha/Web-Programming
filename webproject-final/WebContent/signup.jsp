				...
				<input type="hidden" name="id" value="<%= id %>">
					...
					<div class="contro-group">
						<label class="control-label" for="inputPassword">Password
							Confirm</label>
						<div class="controls">
							<input type="password" id="inputPassword_confirm"
								placeholder="Password Confirm" name="inputpasswordconfirm">
						</div>
					</div>
					<br>
					<% } %>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="inputbirthday" placeholder="Birthday"
								name="inputbirthday" value="<%=birthday %>">
						</div>
					</div>
					<div class="control-group">
